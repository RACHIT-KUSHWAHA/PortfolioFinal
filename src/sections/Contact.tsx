    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="container-px mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          {/* Right: form */}
          <form className="group space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-500 hover:border-white/20 hover:bg-white/8 hover:shadow-xl hover:shadow-purple-500/10" onSubmit={onSubmit}>
            {/* Honeypot (spam trap) */}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input 
                  ...
                  type="text" 
                  required 
                  className="mt-1 w-full rounded-lg border border-white/10 bg-bg/80 px-3 py-2 outline-none transition-all duration-300 focus:border-purple-500/50 focus:bg-bg/90 focus:shadow-lg focus:shadow-purple-500/10" 
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input 
                ...
                name="niche" 
                type="text" 
                placeholder="Tech, Fitness, Vlog, Gaming…" 
                className="mt-1 w-full rounded-lg border border-white/10 bg-bg/80 px-3 py-2 outline-none transition-all duration-300 focus:border-purple-500/50 focus:bg-bg/90 focus:shadow-lg focus:shadow-purple-500/10" 
              />
            </div>
            <div>
              ...
              <textarea 
                ...
                required 
                className="mt-1 w-full rounded-lg border border-white/10 bg-bg/80 px-3 py-2 outline-none transition-all duration-300 focus:border-purple-500/50 focus:bg-bg/90 focus:shadow-lg focus:shadow-purple-500/10" 
                placeholder="Share your niche, deadline, and ideas..." 
              />
            </div>
